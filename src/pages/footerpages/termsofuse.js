...
professional advice. JOURNEY makes no representation or warranty as to the accuracy, <br/>
...
of JOURNEY and its licensors and that you will not acquire any right, title or interest in <br/>
or to the Site or the Content.
</p>

<h1>Disclaimer of Warranties</h1>
<p>JOURNEY MAKES NO REPRESENTATIONS OR WARRANTIES OF ANY KIND, EXPRESS OR <br/>
...
APPLICABLE LAW, JOURNEY DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED, <br/>
INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY AND <br/>
FITNESS FOR A PARTICULAR PURPOSE. JOURNEY WILL NOT BE LIABLE FOR ANY <br/>
...
<p>JOURNEY WILL NOT BE LIABLE TO YOU FOR ANY DAMAGES, INCLUDING WITHOUT <br/>
LIMITATION, INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR SIMILAR DAMAGES, <br/>
EVEN IF JOURNEY HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
</p>

<h1>Indemnification</h1>
<p>You agree to indemnify and hold JOURNEY and its affiliates, officers, agents, and <br/>
...
<p>JOURNEY reserves the right to make changes to this Agreement at any time. Your <br/>
...
<p>This Agreement constitutes the entire agreement between you and JOURNEY with <br/>
...
<Link href='/footerpages/Contact' style={{textDecoration:'none',color:'#f7161a'}}>Contact JOURNEY</Link>.
</p>
